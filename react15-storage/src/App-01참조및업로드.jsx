...
function App() {
  ...
  console.log('경로3', imageRef3.fullPath); //경로1과 동일 
  console.log('경로4', imageRef4.fullPath);  //최상위이므로 빈값 출력
  ...
  return (
    <div className='App'>
      ...
      <input type='file' name='myfile' onChange={(e)=>{
        ...
        // console.log('0번째 파일객체', e.target.files[0]);
        // console.log('0번째 파일명', e.target.files[0].name);
